...
fn shape_node_expression() -> t!(Vec<ShExMLToken>) {
    ...
    token("[", ShExMLToken::SqBrackStart)
        ...
        .labelled("shape_node_expression")
}
...
fn shape_function_application() -> t!(Vec<ShExMLToken>) {
    shape_sub_ident()
        ...
        .labelled("shape_function_application")
}
